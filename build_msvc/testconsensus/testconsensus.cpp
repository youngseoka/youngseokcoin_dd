...
// youngseokcoin includes.
#include <..\src\script\youngseokcoinconsensus.h>
...
int main()
{
    std::cout << "youngseokcoinconsensus version: " << youngseokcoinconsensus_version() << std::endl;
    ...
    auto op0Result = youngseokcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, youngseokcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
