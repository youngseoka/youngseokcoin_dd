Youngseokcoin Core version 0.16.1 is now available from:

  <https://youngseokcoincore.org/bin/youngseokcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting youngseokcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure youngseokcoind processes are cleaned up when tests end (sdaftuar)
