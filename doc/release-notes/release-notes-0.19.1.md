...
Youngseokcoin Core version 0.19.1 is now available from:

  <https://youngseokcoincore.org/bin/youngseokcoin-core-0.19.1/>
...
From Youngseokcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Youngseokcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Youngseokcoin Core does not yet change appearance when
...
- #17488 fix "youngseokcoind already running" warnings on macOS (fanquake)
