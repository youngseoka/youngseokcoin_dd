Youngseokcoin Core version *0.15.2* is now available from:

  <https://youngseokcoincore.org/bin/youngseokcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in youngseokcoin-tx (TheBlueMatt)
