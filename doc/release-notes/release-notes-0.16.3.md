Youngseokcoin Core version 0.16.3 is now available from:

  <https://youngseokcoincore.org/bin/youngseokcoin-core-0.16.3/>
...
been discovered in Youngseokcoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` youngseokcoinconsensus: invalid flags error should be set to `youngseokcoinconsensus_err` (afk11)
