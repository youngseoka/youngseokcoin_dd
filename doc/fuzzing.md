# Fuzzing Youngseokcoin Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Youngseokcoin Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/youngseokcoin/youngseokcoin/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/youngseokcoin/youngseokcoin/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/youngseokcoin/youngseokcoin/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/youngseokcoin/youngseokcoin/tree/master/src/test/fuzz).
...
The project's collection of seed corpora is found in the [`youngseokcoin-core/qa-assets`](https://github.com/youngseokcoin-core/qa-assets) repo.

To fuzz `process_message` using the [`youngseokcoin-core/qa-assets`](https://github.com/youngseokcoin-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/youngseokcoin-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`youngseokcoin-core/qa-assets`](https://github.com/youngseokcoin-core/qa-assets) repo.

Every single pull request submitted against the Youngseokcoin Core repo is automatically tested against all inputs in the [`youngseokcoin-core/qa-assets`](https://github.com/youngseokcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Youngseokcoin Core more robust.
...
with certain assembly code from Youngseokcoin Core's code. See [developer notes on sanitizers](https://github.com/youngseokcoin/youngseokcoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Youngseokcoin Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Youngseokcoin Core using [`afl-fuzz`](https://github.com/google/afl):
...
# Fuzzing Youngseokcoin Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Youngseokcoin Core using [Honggfuzz](https://github.com/google/honggfuzz):
