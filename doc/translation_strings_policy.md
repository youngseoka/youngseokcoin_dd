...
This document provides guidelines for internationalization of the Youngseokcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `youngseokcoin_en.ts` remains unchanged.
