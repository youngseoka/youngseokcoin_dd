Contributing to Youngseokcoin Core
============================

The Youngseokcoin Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/youngseokcoin/youngseokcoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or participate in a weekly [Youngseokcoin Core PR Review Club](https://youngseokcoincore.reviews/) meeting.

Communication Channels
----------------------

Most communication about Youngseokcoin Core development happens on IRC, in the
#youngseokcoin-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/youngseokcoin-core-dev/](http://www.erisian.com.au/youngseokcoin-core-dev/)
and [http://gnusha.org/youngseokcoin-core-dev/](http://gnusha.org/youngseokcoin-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/youngseokcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to youngseokcoin-qt
...
[Translation Process](https://github.com/youngseokcoin/youngseokcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Youngseokcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Youngseokcoin
Network Protocol consensus changes.

Whether a pull request is merged into Youngseokcoin Core rests with the project merge
...
Patches that change Youngseokcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Youngseokcoin consensus, it must have been
...
https://github.com/youngseokcoin/youngseokcoin/pull/16189).

Also see the [backport.py script](
https://github.com/youngseokcoin-core/youngseokcoin-maintainer-tools#backport).

Release Policy
--------------

The project leader is the release manager for each Youngseokcoin Core release.
