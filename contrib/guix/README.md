# Bootstrappable Youngseokcoin Core Builds

This directory contains the files necessary to perform bootstrappable Youngseokcoin
Core builds.
...
- 24GB of free disk space on the partition that the Youngseokcoin Core git repository
  resides in
...
For a Youngseokcoin Core depends development environment, simply invoke
...
From the top of a clean Youngseokcoin Core repository:
...
To use dongcarl's substitute server for Youngseokcoin Core builds after having
