...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the youngseokcoin repository."
  exit 1
fi
...
# See https://github.com/youngseokcoin/youngseokcoin/issues/16064
...
echo 'When compiling youngseokcoind, run `./configure` in the following way:'
echo
