...
By default, youngseokcoind will dump mempool on shutdown and
...
class MempoolPersistTest(YoungseokcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent youngseokcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
