...
"""Test youngseokcoin-cli"""
from decimal import Decimal
from test_framework.test_framework import YoungseokcoinTestFramework
from test_framework.util import assert_equal, assert_raises_process_error, get_auth_cookie

# The block reward of coinbaseoutput.nValue (50) YSC/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 YSC/block.
BLOCKS = 101
BALANCE = (BLOCKS - 100) * 50

class TestYoungseokcoinCli(YoungseokcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `youngseokcoin-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and youngseokcoin-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 YSC) to the default wallet.
