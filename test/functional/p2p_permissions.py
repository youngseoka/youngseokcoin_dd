...
class P2PPermissionsTests(YoungseokcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].youngseokcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].youngseokcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
