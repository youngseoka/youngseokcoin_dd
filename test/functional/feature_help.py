...
"""Verify that starting youngseokcoin with -h works as expected."""

from test_framework.test_framework import YoungseokcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(YoungseokcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start youngseokcoin with -h for help text")
        ...
        self.log.info("Start youngseokcoin with -version for version information")
        ...
        self.log.info("Start youngseokcoind with -fakearg to make sure it does not start")
