...
class TestShell:
    """Wrapper Class for YoungseokcoinTestFramework.

    The TestShell class extends the YoungseokcoinTestFramework
    ...
    class __TestShell(YoungseokcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by YoungseokcoinTestFramework child class.
            self.num_nodes = 1
