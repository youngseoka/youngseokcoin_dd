...
# TestP2PConn: A peer we use to send messages to youngseokcoind, and store responses.
...
class CompactBlocksTest(YoungseokcoinTestFramework):
    ...
    # This test actually causes youngseokcoind to (reasonably!) disconnect us, so do this last.
    ...
    # youngseokcoind's choice of nonce.
    ...
    # Test that youngseokcoind requests compact blocks when we announce new blocks
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # youngseokcoind will not send blocktxn responses for blocks whose height is
