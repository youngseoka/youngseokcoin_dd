...
{
    BOOST_CHECK(TestSplitHost("www.youngseokcoincore.org", "www.youngseokcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.youngseokcoincore.org]", "www.youngseokcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.youngseokcoincore.org:80", "www.youngseokcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.youngseokcoincore.org]:80", "www.youngseokcoincore.org", 80));
