...
#ifndef YOUNGSEOKCOIN_TEST_SCRIPTNUM10_H
#define YOUNGSEOKCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Youngseokcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // YOUNGSEOKCOIN_TEST_BIGNUM_H
