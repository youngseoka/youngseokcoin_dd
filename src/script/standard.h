...
#ifndef YOUNGSEOKCOIN_SCRIPT_STANDARD_H
#define YOUNGSEOKCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a youngseokcoin address
 */
...
/**
 * Generate a Youngseokcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // YOUNGSEOKCOIN_SCRIPT_STANDARD_H
