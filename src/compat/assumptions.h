...
#ifndef YOUNGSEOKCOIN_COMPAT_ASSUMPTIONS_H
#define YOUNGSEOKCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Youngseokcoin cannot be compiled without assertions."
#endif
...
#endif // YOUNGSEOKCOIN_COMPAT_ASSUMPTIONS_H
