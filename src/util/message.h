...
#ifndef YOUNGSEOKCOIN_UTIL_MESSAGE_H
#define YOUNGSEOKCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's youngseokcoin address, it must refer to a public key.
...
#endif // YOUNGSEOKCOIN_UTIL_MESSAGE_H
