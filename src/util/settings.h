...
#ifndef YOUNGSEOKCOIN_UTIL_SETTINGS_H
#define YOUNGSEOKCOIN_UTIL_SETTINGS_H
...
//!       https://github.com/youngseokcoin/youngseokcoin/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored youngseokcoin settings. This struct combines settings from the command line
...
#endif // YOUNGSEOKCOIN_UTIL_SETTINGS_H
