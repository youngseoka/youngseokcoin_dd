 ...
 */
#ifndef YOUNGSEOKCOIN_UTIL_SYSTEM_H
#define YOUNGSEOKCOIN_UTIL_SYSTEM_H
...
extern const char * const YOUNGSEOKCOIN_CONF_FILENAME;
...
#endif // YOUNGSEOKCOIN_UTIL_SYSTEM_H
