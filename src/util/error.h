// Copyright (c) 2010-2019 The Youngseokcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef YOUNGSEOKCOIN_UTIL_ERROR_H
#define YOUNGSEOKCOIN_UTIL_ERROR_H
...
#endif // YOUNGSEOKCOIN_UTIL_ERROR_H
