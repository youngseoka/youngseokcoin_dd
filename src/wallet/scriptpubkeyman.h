...
#ifndef YOUNGSEOKCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define YOUNGSEOKCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Youngseokcoin Core wallet was originally a collection of unrelated private
...
#endif // YOUNGSEOKCOIN_WALLET_SCRIPTPUBKEYMAN_H
