...
#ifndef YOUNGSEOKCOIN_WALLET_TEST_INIT_TEST_FIXTURE_H
#define YOUNGSEOKCOIN_WALLET_TEST_INIT_TEST_FIXTURE_H
...
#endif // YOUNGSEOKCOIN_WALLET_TEST_INIT_TEST_FIXTURE_H
