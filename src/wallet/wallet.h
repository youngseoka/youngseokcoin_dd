...
#ifndef YOUNGSEOKCOIN_WALLET_WALLET_H
#define YOUNGSEOKCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this youngseokcoin node, and set to 0 for transactions that were created
...
#endif // YOUNGSEOKCOIN_WALLET_WALLET_H
