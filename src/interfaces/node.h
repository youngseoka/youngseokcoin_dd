...
#ifndef YOUNGSEOKCOIN_INTERFACES_NODE_H
#define YOUNGSEOKCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a youngseokcoin node (youngseokcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // YOUNGSEOKCOIN_INTERFACES_NODE_H
