...
#ifndef YOUNGSEOKCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define YOUNGSEOKCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@youngseokcoin.
 *
 ...
 *
 * The chacha20-poly1305@youngseokcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@youngseokcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@youngseokcoin are relatively fast in
...
#endif // YOUNGSEOKCOIN_CRYPTO_CHACHA_POLY_AEAD_H
