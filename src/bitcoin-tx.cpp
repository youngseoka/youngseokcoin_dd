...
static void SetupYoungseokcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " youngseokcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  youngseokcoin-tx [options] <hex-tx> [commands]  Update hex-encoded youngseokcoin transaction\n" +
            "or:     youngseokcoin-tx [options] -create [commands]   Create hex-encoded youngseokcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded youngseokcoin transaction
