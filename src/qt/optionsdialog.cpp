    ...
    mapper(nullptr)
{
    ...
    ui->youngseokcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->youngseokcoinAtStartup);
    ...
    ui->youngseokcoinAtStartup->setToolTip(ui->youngseokcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->youngseokcoinAtStartup->setText(ui->youngseokcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openYoungseokcoinConfButton->setToolTip(ui->openYoungseokcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new YoungseokcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->youngseokcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openYoungseokcoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openYoungseokcoinConf())
