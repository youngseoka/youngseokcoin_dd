...
#ifndef YOUNGSEOKCOIN_QT_SPLASHSCREEN_H
#define YOUNGSEOKCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Youngseokcoin Core initialization
...
#endif // YOUNGSEOKCOIN_QT_SPLASHSCREEN_H
