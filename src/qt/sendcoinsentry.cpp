    ...
    platformStyle(_platformStyle)
{
    ...
    // normal youngseokcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying youngseokcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &YoungseokcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
