...
#ifndef YOUNGSEOKCOIN_QT_WALLETMODEL_H
#define YOUNGSEOKCOIN_QT_WALLETMODEL_H
...
/** Interface to Youngseokcoin wallet from Qt view code. */
...
#endif // YOUNGSEOKCOIN_QT_WALLETMODEL_H
